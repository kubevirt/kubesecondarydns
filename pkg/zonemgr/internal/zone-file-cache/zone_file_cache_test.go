...
var _ = Describe("cached zone file content maintenance", func() {
	...
	Describe("cached zone file records update", func() {
		...
		var (
			...
			defARecord_nic1_vm1_ns1 = fmt.Sprintf(defARecordFmt, vmi1Name, namespace1, nic1IP)
			defARecord_nic2_vm1_ns1 = fmt.Sprintf(defARecordFmt, vmi1Name, namespace1, nic2IP)
			defARecord_nic1_vm2_ns1 = fmt.Sprintf(defARecordFmt, vmi2Name, namespace1, nic1IP)
			defARecord_nic3_vm2_ns1 = fmt.Sprintf(defARecordFmt, vmi2Name, namespace1, nic3IP)
		)
